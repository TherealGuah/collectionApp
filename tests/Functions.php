...
class Functions extends TestCase
{
    ...
    public function test_addItemToHTML_GivenDataReturnsHTML() {
        ...
        $expected = '<div class = "itemContainer">'
                        . '<h2>The devastation of Baal</h2>'
                        . '<p>Author: Guy Haley</p>'
                        . '<div>'
                        ...
                        . '</div>'
                        . '<p>About: Baal is besieged! The alien horror of Hive Fleet Leviathan has reached the Blood Angels home world, and their entire existence is under threat. As the sons of Sanguinius gather, the battle for the fate of their bloodline begins...</p>'
