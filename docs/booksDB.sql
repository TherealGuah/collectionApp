...
CREATE TABLE `books_categories` (
                                    ...
                                    KEY `book_id` (`book_id`),
                                    CONSTRAINT `books_categories_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`),
                                    CONSTRAINT `books_categories_ibfk_2` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `books_categories` (`category_id`, `book_id`)
VALUES (1, 7);
-- Mephiston: Blood of S.
INSERT INTO `books_categories` (`category_id`, `book_id`)
VALUES (4, 8);
INSERT INTO `books_categories` (`category_id`, `book_id`)
VALUES (1, 8);
-- Last Flight of the E.
INSERT INTO `books_categories` (`category_id`, `book_id`)
VALUES (4, 9);
INSERT INTO `books_categories` (`category_id`, `book_id`)
VALUES (1, 9);
